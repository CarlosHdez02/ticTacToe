...
//Adding animation when game ends
...
function checkScore() {
  ...
  const isDraw = tileValues.every((val) => val);
  if (isDraw) {
...
function handleGameboardClick(e) {
  if (e.target.classList.contains("tile") && !e.target.dataset.value) {
